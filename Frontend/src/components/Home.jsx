...
import { SliderTop } from "../layouts/SliderTop.jsx";
    ...
    <div>
          ...
          <div className=" font-poppins font-light text-2xl w-auto h-96 p-16 ">
            ...
            <div className=" flex flex-row w-96 h-40 justify-start items-center">
              <a
                ...
                target="_blank"
              >
                <button className="text-[#0D2E48] rounded-full px-8 py-2 text-base font-medium  font-poppins hover:bg-[#0D2E48] hover:text-white transition-all border-2 w-72 h-14 border-[#0D2E48] focus:outline-none focus:border-[#0D2E48] flex flex-row justify-center items-center">
                  Get to know us
      ...
      <div className="w-full h-auto flex flex-col mt-16">
        <div className="font-poppins p-16">
          <h3 className=" font-light text-1xl text-[#0D2E48] mb-8">
            WHAT WE DO
          </h3>
          <h3 className=" font-poppins font-medium text-5xl text-[#0D2E48]">
            We're here to simplify your business life with tailored solutions.
            Our services and packages are flexible to meet your specific needs.
          </h3>
        </div>
          ...
          <div className=" flex flex-row justify-self-center">
            ...
            <div className="flex flex-col gap-8 mt-24">
              <a href="#" target="_blank" className=" ml-4">
                <button className="text-[#0D2E48] rounded-full px-8 py-2 text-base font-medium  font-poppins hover:bg-[#0D2E48] hover:text-white transition-all border-2 w-auto h-12 border-[#0D2E48] focus:outline-none focus:border-[#0D2E48] flex flex-row justify-center items-center">
      ...
      {/*OUR SERVICES*/}
      <div className="w-full h-auto flex flex-col mt-16 overflow-hidden">
        <div className="font-poppins p-16">
          <h3 className=" font-light text-1xl text-[#0D2E48] mb-8">
            OUR SERVICES
          </h3>
          <h3 className=" font-poppins font-medium text-5xl text-[#0D2E48]">
            It is important to target the right audience in the market, build
            relationship with them, as well as to keep the latest updates in
            line.
          </h3>
        </div>
